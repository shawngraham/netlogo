...
turtles-own
[amphora] ;;idea being that we have an expanding world of cities that have a preference for a certain kind of artefact. Exploring trade networks formation where there are two mechanisms, pref attachement for links versus bias for similar material culture.
